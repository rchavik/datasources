...
require_once CORE_PATH . 'Cake'. DS . 'Test' . DS . 'Case' . DS . 'Model' . DS . 'models.php'; //DS dirname(dirname(dirname(__FILE__))) . 
 ...
 * @package       Cake.Test.Case.Model.Datasource.Database
 */
class MssqlTestModel extends CakeTestModel {
 ...
 * @package       Cake.Test.Case.Model.Datasource.Database
 */
class MssqlClientTestModel extends CakeTestModel {
 ...
 */
	public function testFields() {
		$fields = array(
			'[MssqlTestModel].[id] AS [MssqlTestModel__id]',
			'[MssqlTestModel].[client_id] AS [MssqlTestModel__client_id]',
			'[MssqlTestModel].[name] AS [MssqlTestModel__name]',
			'[MssqlTestModel].[login] AS [MssqlTestModel__login]',
			'[MssqlTestModel].[passwd] AS [MssqlTestModel__passwd]',
			'[MssqlTestModel].[addr_1] AS [MssqlTestModel__addr_1]',
			'[MssqlTestModel].[addr_2] AS [MssqlTestModel__addr_2]',
			'[MssqlTestModel].[zip_code] AS [MssqlTestModel__zip_code]',
			'[MssqlTestModel].[city] AS [MssqlTestModel__city]',
			'[MssqlTestModel].[country] AS [MssqlTestModel__country]',
			'[MssqlTestModel].[phone] AS [MssqlTestModel__phone]',
			'[MssqlTestModel].[fax] AS [MssqlTestModel__fax]',
			'[MssqlTestModel].[url] AS [MssqlTestModel__url]',
			'[MssqlTestModel].[email] AS [MssqlTestModel__email]',
			'[MssqlTestModel].[comments] AS [MssqlTestModel__comments]',
			'CONVERT(VARCHAR(20), [MssqlTestModel].[last_login], 20) AS [MssqlTestModel__last_login]',
			'[MssqlTestModel].[created] AS [MssqlTestModel__created]',
			'CONVERT(VARCHAR(20), [MssqlTestModel].[updated], 20) AS [MssqlTestModel__updated]'
		);
		...
		$expected = array_merge($fields, array(
			'[MssqlClientTestModel].[id] AS [MssqlClientTestModel__id]',
			'[MssqlClientTestModel].[name] AS [MssqlClientTestModel__name]',
			'[MssqlClientTestModel].[email] AS [MssqlClientTestModel__email]',
			'CONVERT(VARCHAR(20), [MssqlClientTestModel].[created], 20) AS [MssqlClientTestModel__created]',
			'CONVERT(VARCHAR(20), [MssqlClientTestModel].[updated], 20) AS [MssqlClientTestModel__updated]'));
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testUpdateAllSyntax() {
		...
		$result = $this->db->getLastQuery();
		$this->assertNotRegExp('/MssqlTestModel/', $result);
